...
var TAB_WIDTHS = new Array("200px", "420px", "600px");
...
function printSelectedMonth3() {
	getSelectedMonth();
	return printHead2(currentMonth, currentYear);
}
...
function printTable2(mm, yy) {
	...
	var LunarHead = getYearCanChi(ld1.year);
	var res = "";
	res += ('<div class="calendar">\n');
	// res += printHead(mm, yy);
    for(var i=0;i<=6;i++) {
		res += ('<span class="day-name">'+DAYNAMES[i]+'</span>');
	}
	res += ('\n');
	for (i = 0; i < 6; i++) {
		// res += ("<div>\n");
		for (j = 0; j < 7; j++) {
			k = 7 * i + j;
			if (k < emptyCells || k >= emptyCells + currentMonth.length) {
				res += ('<div class="day day--disabled"></div>\n');
			} else {
				solar = k - emptyCells + 1;
				ld1 = currentMonth[k - emptyCells];
				res += printCell2(ld1, solar, mm, yy);
			}
		}
		// res += ("</div>\n");
	}
	// res += ('<section class="task task--danger">Design Sprint</section>\n');
	res += ('</div>\n');
	return res;
}
...
function getPrevMonthLink(mm, yy) {
	...
	return '<a href="'+window.location.pathname+'?yy='+yy1+'&mm='+mm1+'"><i class="fa fa-angle-left fa-lg" aria-hidden="true"></i></a>';
}
...
function getNextMonthLink(mm, yy) {
	...
	return '<a href="'+window.location.pathname+'?yy='+yy1+'&mm='+mm1+'"><i class="fa fa-angle-right fa-lg" aria-hidden="true"></i></a>';
}

function getPrevYearLink(mm, yy) {
	//return '<a href="'+window.location.pathname+'?yy='+(yy-1)+'&mm='+mm+'"><img src="left2.gif" width=16 height=12 alt="PrevYear" border=0></a>';
	return '<a href="'+window.location.pathname+'?yy='+(yy-1)+'&mm='+mm+'"><i class="fa fa-angle-double-left fa-lg" aria-hidden="true"></i></a>';
}

function getNextYearLink(mm, yy) {
	//return '<a href="'+window.location.pathname+'?yy='+(yy+1)+'&mm='+mm+'"><img src="right2.gif" width=16 height=12 alt="NextYear" border=0></a>';
	return '<a href="'+window.location.pathname+'?yy='+(yy+1)+'&mm='+mm+'"><i class="fa fa-angle-double-right fa-lg" aria-hidden="true"></i></a>';
}
...
function printHead2(mm, yy) {
	...
	res += ('<div class="title">'+monthName+'</div>\n');
	res += ('<div class="title next">'+getPrevMonthLink(mm, yy)+' &nbsp;'+getNextMonthLink(mm, yy)+'</div>\n');
	return res;
}
...
function printCell2(lunarDate, solarDate, solarMonth, solarYear) {
	var cellClass, solarClass, lunarClass, solarColor;
	cellClass = "day";
	solarClass = "t2t6";
	lunarClass = "am";
	...
	var args = lunarDate.day + "," + lunarDate.month + "," + lunarDate.year + "," + lunarDate.leap;
	args += ("," + lunarDate.jd + "," + solarDate + "," + solarMonth + "," + solarYear);
	res += ('<div class="'+cellClass+'">'+solarDate+'</div>\n');
	return res;
}
